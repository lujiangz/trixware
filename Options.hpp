...
public:
	...
	OPTION(bool, aspectratioenable, false);
	OPTION(int, aspectratioen_x, 1085);
	OPTION(int, aspectratioen_y, 610);
	OPTION(int, roll, 0);
	OPTION(bool, fake_chams, false);
	OPTION(int, silahdeger, 0);
	OPTION(bool, backtrack_bhd_wall_only, false);
	OPTION(bool, silahdondurme, false);
	OPTION(bool, esp_localplayer_chams_xyz, false);
	OPTION(int, esp_localplayer_chams_type, 0);
	OPTION(bool, otuzbiresp, 0);
...
/////////////////////////////////////////////
	...
	{
		bool Enable;
		OPTION(ButtonCode_t, trigkey, BUTTON_CODE_NONE);
		bool Head;
		bool Arms;
		bool Chest;
		bool Stomach;
		...
		//rifles
		bool Rifles_Enable;
		OPTION(ButtonCode_t, Rifles_Key, BUTTON_CODE_NONE);
		bool Rifles_Head;
		bool Rifles_Arms;
		bool Rifles_Chest;
		bool Rifles_Stomach;
		...
		//pistols
		bool Pistols_Enable;
		OPTION(ButtonCode_t, Pistols_Key, BUTTON_CODE_NONE);
		...
		//snipers
		bool Snipers_Enable;
		OPTION(ButtonCode_t, Snipers_Key, BUTTON_CODE_NONE);
		bool Snipers_Head;
		bool Snipers_Arms;
		bool Snipers_Chest;
	...
	OPTION(ButtonCode_t, aimkey, BUTTON_CODE_NONE);
	...
	OPTION(int, hitbox_mg, 0);
	OPTION(bool, aim_LegitBotmg, false);
	OPTION(float, legit_smooth_mg, 1.f);
	OPTION(float, legit_fov_mg, 1.f);
	OPTION(float, bactrack_ms, 0.f);
	OPTION(bool, backtrack_visualize, false);
	OPTION(bool, bactrack, false);
	OPTION(float, legit_rcsmin_mg, 0.f);
	OPTION(float, legit_rcsmax_mg, 0.f);
	...
	OPTION(bool, takimarkadas, false);
	...
	OPTION(bool, force_crosshair, false);
